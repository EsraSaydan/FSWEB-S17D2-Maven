...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1, new SeniorDeveloper(1,"Esra",1000d/* Experience.SENIOR*/));
//        this.developers.put(2, new JuniorDeveloper(2,"Merve",6000d/* Experience.SENIOR*/));
//        this.developers.put(3, new JuniorDeveloper(3,"Burcu",6000d/* Experience.SENIOR*/));
